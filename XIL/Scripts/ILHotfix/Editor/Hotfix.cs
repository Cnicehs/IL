    ...
    .ToDictionary(f => f.Name, f => ((OpCode)f.GetValue(null)));
        ...
        public static void HotfixInject(string inject_assembly_path, Func<HashSet<string>> fun)
        {
            ...
            try
            {
                ...
                var exports = fun();
                assembly.MainModule.Types.Add(new TypeDefinition("__IL_GEN", "__IL_GEN_FLAG", ILRuntime.Mono.Cecil.TypeAttributes.Class, objType));
        ...
        static void ResetInstruction(ILRuntime.Mono.Cecil.Cil.MethodBody body)
        {
            int offset = 0;
        ...
        static void ComputeStackSize(Instruction instruction, ref Dictionary<Instruction, int> stack_sizes, ref int stack_size, ref int max_stack)
        {
            ...
            {
                var CodeWriter = typeof(Instruction).Assembly.GetType("ILRuntime.Mono.Cecil.Cil.CodeWriter");
        ...
        static void ComputeExceptionHandlerStackSize(ILRuntime.Mono.Cecil.Cil.MethodBody body, ref Dictionary<Instruction, int> stack_sizes)
        {
        ...
        static Instruction findNextRet(ILRuntime.Mono.Collections.Generic.Collection<Instruction> instructions, Instruction pos)
        {
            bool posFound = false;
        ...
        public static void LogInfo(string key, ILRuntime.Mono.Collections.Generic.Collection<Instruction> Instructions)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder();
        ...
        static void fixBranch(ILProcessor processor, ILRuntime.Mono.Collections.Generic.Collection<Instruction> instructions, Dictionary<Instruction, Instruction> originToNewTarget, HashSet<Instruction> noCheck)
        {
        ...
        static bool injectGenericMethod(AssemblyDefinition assembly, MethodDefinition method)
        {
            ...
            FieldDefinition fieldDefinition = new FieldDefinition(luaDelegateName, ILRuntime.Mono.Cecil.FieldAttributes.Static | ILRuntime.Mono.Cecil.FieldAttributes.Private, delegateBridgeType);
            type.Fields.Add(fieldDefinition);
